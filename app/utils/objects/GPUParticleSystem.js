 ...
 * @Last Modified time: 2019-07-15 19:56:50
 * @Description: 
 */
/*
 * GPU Particle System
...
// ./public/imgs/pos.png
	this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( './public/imgs/perlin-512.png' );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = RepeatWrapping;

	this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( './public/imgs/particle2.png' );
